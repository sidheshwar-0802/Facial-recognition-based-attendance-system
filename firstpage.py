...
Label(root, text="FACIAL RECOGNITION BASED ATTENDANCE SYSTEM",font=("times new roman",20),fg="white",bg="maroon",height=6).grid(row=0,rowspan=2,columnspan=2,sticky=N+E+W+S,padx=5,pady=5)
